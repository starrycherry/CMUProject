...
public class FAProductionSummaryEntity {
	...
	public FAProductionSummaryEntity(String name, String today, String yesterday,  String mtd, String prev_month, String ytd, String prev_year){
		this.name = name;
		this.today = today;
